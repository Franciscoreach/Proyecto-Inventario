    ...
    async function submitRegistration(e) {
        ...
        try {
            ...
            if (response.status === 201) {
                Swal.fire('Correcto', 'Usuario creado satisfactoriamente', 'success');
            }
        ...
        <div class="font-[sans-serif] bg-gray-900 md:h-screen">
            <div class="grid md:grid-cols-2 items-center gap-8 h-full">
                ...
                <div class="flex items-center md:p-8 p-6 bg-white md:rounded-tl-[55px] md:rounded-bl-[55px] h-full">
                    <form class="max-w-lg w-full mx-auto" onSubmit={submitRegistration}>
                        <div class="mb-12">
                            <h3 class="text-gray-800 text-4xl font-extrabold">Registro</h3>
                            <p class="text-gray-800 text-sm mt-4 "> ¿Ya tienes una cuenta? <a href="/login" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Inicia sesión acá</a></p>
                        </div>
                        ...
                        <div className='mt-8'>
                            <label class="text-gray-800 text-xs block mb-2">Usuario</label>
                            <div class="relative flex items-center">
                                <input name="username" type="text" required class="w-full text-sm border-b border-gray-300 focus:border-gray-800 px-2 py-3 outline-none" placeholder="Escribe tu usuario" value={username} onChange={e => setUsername(e.target.value)}
                                />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
                                    <defs>
                                        <clipPath id="a" clipPathUnits="userSpaceOnUse">
                        ...
                        <div class="mt-8">
                            ...
                            <div class="relative flex items-center">
                                <input name="password" id='pass' type="password" required class="w-full text-sm border-b border-gray-300 focus:border-gray-800 px-2 py-3 outline-none" placeholder="Escribe tu contraseña" value={password}
