            ...
            <td class="p-4 text-sm">
              <div class="flex items-center cursor-pointer w-max">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-xs text-gray-500">gladys@example.com</p>
                </div>
              </div>
            </td>
            <td class="p-4 text-sm">
            ...
            <td class="p-4 text-sm">
              <div class="flex items-center cursor-pointer w-max">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-xs text-gray-500">jennie@example.com</p>
                </div>
              </div>
            </td>
            <td class="p-4 text-sm">
            ...
            <td class="p-4 text-sm">
              <div class="flex items-center cursor-pointer w-max">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-xs text-gray-500">philip@example.com</p>
                </div>
              </div>
            </td>
            <td class="p-4 text-sm">
            ...
            <td class="p-4 text-sm">
              <div class="flex items-center cursor-pointer w-max">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-xs text-gray-500">jorge@example.com</p>
                </div>
              </div>
            </td>
            <td class="p-4 text-sm">
            ...
            <td class="p-4 text-sm">
              <div class="flex items-center cursor-pointer w-max">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-xs text-gray-500">evan@example.com</p>
                </div>
              </div>
            </td>
            <td class="p-4 text-sm">
